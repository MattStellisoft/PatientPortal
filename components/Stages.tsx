...
export default function Stages({ patientSteps }) {
    return (
                            ...
                            >
                                {step.status === "complete" ? (
                                    ...
                                    <>
                                        ...
                                        <span className="relative flex items-start group">
                                            <span className="h-9 flex items-center">
                                                <span className="relative z-10 w-8 h-8 flex items-center justify-center bg-blue-750 rounded-full group-hover:bg-blue-800">
                                                    <CheckIcon
                                                        className="w-5 h-5 text-white"
                                                        aria-hidden="true"
                                                    />
                                            ...
                                            <span>
                                                <span className="ml-4 min-w-0">
                                                    <Disclosure.Button className="text-left text-sm font-medium focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                                                        ...
                                                        <span className="flex items-center">
                                                            <span className="inline-flex items-center border-2 border-blue-750 text-blue-750 rounded-full">
                                                                <ChevronUpIcon
                                                                    className={`${
                                                                        open
                                                                            ? "rotate-180 transform"
