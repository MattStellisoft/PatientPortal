...
const tier = [
    ...
    'have an active referral with us.'
];
          ...
          <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div className="mx-auto w-full max-w-sm lg:w-96">
              <div>
                ...
                />
                <h2 className="mt-6 text-3xl font-extrabold text-gray-900">Sign in using NHS Login</h2>
              </div>
  
              <div className="mt-8">
                <p className="text-lg">To access services using our Patient Portal you must be:</p>
                <ul role="list" className="mt-6 space-y-4">
                  {tier.map((feature) => (
                    <li key={feature} className="flex space-x-3">
                      <CheckIcon className="flex-shrink-0 h-8 w-8 text-blue-900" aria-hidden="true" />
