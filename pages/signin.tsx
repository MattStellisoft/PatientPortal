            ...
            <div className="flex-1 flex flex-col justify-center lg:flex-none">
                ...
                <div className="min-h-screen mx-auto lg:w-96 flex flex-col">
                    ...
                    <div className="p-8 flex justify-center flex-col">
                        <div>
                            <a
                                href="https://auth.sandpit.signin.nhs.uk/authorize?scope=openid%20profile%20email%20phone&client_id=CHITU&redirect_uri=http://localhost:3000/api/callback&response_type=code&state=appstate&nonce=randomnonce"
                                className=""
                            >
                                <svg
